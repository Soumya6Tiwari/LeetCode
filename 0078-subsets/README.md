<h2><a href="https://leetcode.com/problems/subsets/">78. Subsets</a></h2><h3>Medium</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given an integer array <code style="user-select: auto;">nums</code> of <strong style="user-select: auto;">unique</strong> elements, return <em style="user-select: auto;">all possible</em> <span data-keyword="subset" style="user-select: auto;"><em style="user-select: auto;">subsets</em></span> <em style="user-select: auto;">(the power set)</em>.</p>
